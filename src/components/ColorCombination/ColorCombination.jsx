    ...
    return(
        <div className='my-40'>
            <div className='text-center my-10'>
                <h1 ref={ref1} className={`${isVisible1 ? 'animate-fadeUp' : 'opacity-0'} font-helveticaBold font-bold text-4xl`}>Color Harmonies</h1>
                <h3 ref={ref2} className={`${isVisible2 ? 'animate-fadeUp' : 'opacity-0'} font-helveticaLight`}>What works together</h3>
            ...
            <div className='h-[600vh] relative' ref={scrollerRef}>
                ...
                {currentStep === 0 && (
                    <div ref={ref4} className={`${isVisible4 ? 'animate-fadeIn' : 'opacity-0'} w-full h-full bg-cover bg-center sm:rounded-2xl relative`} 
                        ...
                        <div className='m-6 lg:max-w-lg absolute bottom-5 sm:bottom-0 text-white'>
                            <h1 ref={ref5} className={`${isVisible5 ? 'animate-fadeUp' : 'opacity-0'} font-helveticaBold font-bold text-3xl sm:text-4xl`}>Complimentary</h1>
                            <p ref={ref6} className={`${isVisible6 ? 'animate-fadeSlide' : 'opacity-0'} font-helveticaLight mx-4 text-xs sm:text-base`}>Opposite colors on the wheel (e.g., blue & orange). High contrast and energy.</p>
                        </div>
                ...
                {currentStep === 1 && (
                    <div ref={ref4} className={`${isVisible4 ? 'animate-fadeIn' : 'opacity-0'} w-full h-full bg-cover bg-center sm:rounded-2xl relative`} 
                        ...
                        <div className='m-6 lg:max-w-lg absolute bottom-5 sm:bottom-0 text-white'>
                            <h1 ref={ref5} className={`${isVisible5 ? 'animate-fadeUp' : 'opacity-0'} font-helveticaBold font-bold text-3xl sm:text-4xl`}>Analogous</h1>
                            <p ref={ref6} className={`${isVisible6 ? 'animate-fadeSlide' : 'opacity-0'} font-helveticaLight mx-4 text-xs sm:text-base`}>Colors that are next to each other (e.g., red, red-orange, orange). Calm and natural.</p>
                        </div>
                ...
                {currentStep === 2 && (
                    <div ref={ref4} className={`${isVisible4 ? 'animate-fadeIn' : 'opacity-0'} w-full h-full bg-cover bg-center sm:rounded-2xl relative`}
                        ...
                        <div className='m-6 lg:max-w-lg absolute bottom-5 sm:bottom-0 text-white'>
                            <h1 ref={ref5} className={`${isVisible5 ? 'animate-fadeUp' : 'opacity-0'} font-helveticaBold font-bold text-3xl sm:text-4xl`}>Triadic</h1>
                            <p ref={ref6} className={`${isVisible6 ? 'animate-fadeSlide' : 'opacity-0'} font-helveticaLight mx-4 text-xs sm:text-base`}>Three colors evenly spaced (e.g., red, yellow, blue). Vibrant and balanced.</p>
                        </div>
