    ...
    return(
        <div className="my-20 flex flex-wrap justify-center items-center relative xl:mt-28">
            <div className="mx-[12vw] mt-4 max-w-md sm:max-w-lg sm:my-6 lg:mx-6 lg:max-w-md xl:mx-12 xl:max-w-lg">
                <h1 className="animate-fadeUpDelay text-[clamp(1rem,11vw,56px)] leading-tight font-helveticaBold font-bold 
            ...
            <div className="animate-fadeIn w-4/5 max-w-md aspect-square rounded-full overflow-hidden m-4 sm:w-3/4 lg:w-1/3 xl:mx-12">
                <img src={colorWheel} alt="Color Wheel" className="w-full h-full object-cover animate-spinn"/>
            </div>
            <div className="animate-fadeUp bg-gray-200/80 backdrop-blur-lg rounded-2xl mt-8 mx-[10vw] p-4 max-w-lg absolute top-2/3 lg:top-3/4 lg:max-w-2xl xl:top-[80%]
                            dark:bg-gray-800/80">
